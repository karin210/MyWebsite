  ...
  return (
    <>
      <AboutMe stackH2="Tech_Stack">
        ...
        Guadalajara who taught me some basics of frontend development. I learnt my
        main skills by reading documentation on sites such as w3schools.com,
        developer.mozilla.org, the official websites of technologies like
        React and Next.js, and some YouTube channels about programming. I took
        ...
        <TextBlock
          ...
          body="I had no knowledge about the programming fields, I just wanted to get
          into the Tech industry. Before I'd started to read about the
          ...
          I'd heard working in Tech were different than other industries
          and work in such a big projects would be great!. 
          I thought the first thing I had to do was learn how to build a
          website, so I found several websites builders like Wix and WordPress
          but I wanted to learn how to code it. Finally found I needed to learn
          HTML, CSS and JavaScript. Asked to my developer
